function [IP,ID,IC,ITheta,IPsi,IPhi,IBaseline,Iu,Icost] = itLQR_acc(n,...
...
optimfun = @(u) controlCost_acc(u,W,Wn,R,m,N,T,x0,fun,xstar);

% generate random guesses
[baseLine,data] = randomSamples_acc(NumExp,T,N,x0,u0,pert,fun);
...
for iter = 2:NumIter
    ...
    baseLine = improveSamples_acc(T,N,x0,Theta,Psi,...
    ...
    [baseLine,data] = randomSamples_acc(NumExp,T,N,x0,uNew,pert,fun);
